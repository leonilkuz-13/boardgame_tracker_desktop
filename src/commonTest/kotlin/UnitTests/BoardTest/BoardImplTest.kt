...
class BoardImplTest {
    ...
    fun `updateCellStatus throws exception for out of bounds coordinate`() {
        ...
        assertFailsWith<IllegalArgumentException>("Expected IllegalArgumentException for out of bounds coordinate") {
    ...
    fun `getCellStatus throws exception for out of bounds coordinate`() {
        ...
        assertFailsWith<IllegalStateException>("Expected IllegalStateException for out of bounds coordinate") {
