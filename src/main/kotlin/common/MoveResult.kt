...
sealed class MoveResult {
    ...
    sealed class Success : MoveResult() {
        ...
        data class Sunk(override val coordinate: Coordinate, val affectedCoordinates: Set<Coordinate>) : Success()
        data class Over(override val coordinate: Coordinate, val affectedCoordinates: Set<Coordinate>) : Success()
    }
